...
pkg_path = rospack.get_path('turtlebot3_human_tracking')  # MUST match package.xml <name>

proto = os.path.join(pkg_path, 'trained_network', 'MobileNetSSD_deploy.prototxt.txt')
model = os.path.join(pkg_path, 'trained_network', 'MobileNetSSD_deploy.caffemodel')
